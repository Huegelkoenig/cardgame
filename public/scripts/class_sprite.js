...
class Sprite{
  ...
  draw(ctx, target){
    ctx.drawImage(this.img, this.origin.x, this.origin.y, this.origin.width, this.origin.height, target.x+target.offset.x, target.y+target.offset.y, target.width, target.height);
  }

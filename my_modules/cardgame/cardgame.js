...
function initGame(socket){
  const listOfFilesToLoad = {images: [{size: 113, name: 'clubs'                }, //array of graphics and sounds + user-dependant graphics and sounds //TODO: insert real values                                      
                                      ...
                                      {size:  18, name: 'mainMenu_background'  },
                                      {size:  29, name: 'test_background'      },
                                      ...
                                      {size:  18, name: 'quickstart_background' },
                                      {size:  20, name: 'createGame_background'},
                                      {size:  18, name: 'joinGame_background'  }

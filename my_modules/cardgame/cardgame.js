...
function initGame(socket){
  const listOfFilesToLoad = {list: [
                             {type: 'image',  name: 'hearts',             size:  99}, //array of graphics and sounds + user-dependant graphics and sounds //TODO: insert real values
                             ...
                             {type: 'image',  name: 'diamonds_highlighted', size: 118},
                             {type: 'image',  name: 'aatolex',            size: 22}]}; //append user specific imags or sounds
  let imagesize = 0;
